...
export default function FichaProfesor({ onSubmit }) {
  ...
  return (
    <form className="card p-4 shadow-sm" onSubmit={handleSubmit}>
      <h4 className="fw-bold mb-4 text-center">Ficha de Datos Profesor</h4>
      ...
      {/* PLANES */}
      <h6 className="fw-bold mb-3">Disciplina</h6>

      <div className="mb-3">
        <label className="form-label">Disciplina a dictar</label>
        <select
